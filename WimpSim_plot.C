...
void AnalyzeCuts(){
  ...
  TFile *_file0 = TFile::Open("root_file/Newwimpscut_tautau_20gev_Ralffix_dec8.root");
  //  TFile *_file0 = TFile::Open("root_file/Newwimpscut_tautau_20gev_Ralffix_dec12_Onlyupmu.root");
  TTree *myt=(TTree*)_file0->Get("flux");
  gROOT->ForceStyle();
  myt->Print();
  myt->Draw("tpx>>fNuRate");
  ...
  prelim->Draw();
  c.SaveAs("WIMPSIM_plot/WIMPSIM_plot_Neutrino_rate.pdf");
  c.Update();
